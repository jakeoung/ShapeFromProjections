...
#         N_bx2 = torch.zeros([vecs.shape[0], 2], dtype=dtype).cuda() # vecs[:,12]=0
...
#         proj_bxpx2 = torch.zeros([P_D_bxvx3.shape[0],P_D_bxvx3.shape[1], 2], dtype=dtype).cuda()
...
#                              self.labels_fx2, mus_n, self.height, self.width)
#         phat = phat.squeeze()
#         return phat, get_valid_mask(phat, self.max_sino_val)
